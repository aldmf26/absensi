...
class AbsensiAgrilaras extends Controller
{
    ...
    public function exportGaji(Request $r)
    {
        ...
        $sheet
            ...
            ->setCellValue('F1', 'GAJI TOTAL M')
            ->setCellValue('G1', 'GAJI TOTAL E')
            ->setCellValue('H1', 'GAJI TOTAL SP')
            ->setCellValue('I1', 'GAJI BULANAN');
        ...
        foreach ($query as $k) {
            $sheet
                ...
                ->setCellValue('C' . $kolom, $k->qty_m)
                ->setCellValue('D' . $kolom, $k->qty_e)
                ->setCellValue('E' . $kolom, $k->qty_sp)
                ->setCellValue('F' . $kolom, $k->ttl_gaji_m)
                ->setCellValue('G' . $kolom, $k->ttl_gaji_e)
                ->setCellValue('H' . $kolom, $k->ttl_gaji_sp)
                ->setCellValue('I' . $kolom, $k->g_bulanan);
            $kolom++;
        }
